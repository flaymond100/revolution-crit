  ...
  return (
    ...
    <div className="container mx-auto px-4">
      <div className="flex items-center justify-between py-4">
        <div>
          <img src="public/assets/logo.png" alt="Logo" className="w-full h-10" />
        </div>

        <div className="hidden sm:flex sm:items-center">
          <Link to="/" className={`text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4 ${isActive('/') ? 'text-purple-600' : ''}`}>Home</Link>
          <Link to="/calendar" className={`text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4 ${isActive('/calendar') ? 'text-purple-600' : ''}`}>Calendar</Link>
        </div>
      ...
      <div className="block sm:hidden bg-white border-t-2 py-2">
        <div className="flex flex-col">
          ...
          <Link to="/about" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">About</Link>
